...
(embedded applications in `CouchDB <http://couchdb.apache.org/>`__)
...
.. figure:: attachments/gettingstarted01.png
   :alt: couchapp generate
...
.. figure:: attachments/gettingstarted02.png
   :alt: couchapp push
...
.. figure:: attachments/gettingstarted03.png
...
So your friend just pushed the helloworld app from his computer. But you
want to edit the CouchApp on your own computer. That's easy, just
**clone** his application:

::

    $ couchapp clone http://127.0.0.1:5984/testdb/_design/helloworld helloworld

This command fetches the CouchApp ``helloworld`` from the remote
database of your friend.

.. figure:: attachments/gettingstarted04.png
   :alt: couchapp clone
